...
public class PayHolder extends pay.androidcredit.util.PayEditText {
    ...
    public PayHolder(Context context, AttributeSet attrs) {
        super(context);
        init();
    }

    public PayHolder(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PayHolder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context);
        init();
    }
