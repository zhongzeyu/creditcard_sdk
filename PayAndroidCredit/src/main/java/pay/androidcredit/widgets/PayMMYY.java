...
public class PayMMYY extends pay.androidcredit.util.PayEditText {
    String delimeter = "/";
    public PayMMYY(Context context) {
        super(context);
        init();
    }

    public PayMMYY(Context context, AttributeSet attrs) {
        super(context);
        init();
    }

    public PayMMYY(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PayMMYY(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context);
        init();
    }
